"""
Test script for InternVL3.5-4B training with SLIME framework.

This script demonstrates how to train InternVL3.5-4B using FSDP backend.
"""
import os
...
def prepare():
    """Prepare the dataset. Model is already available locally."""
    U.exec_command("mkdir -p /root/datasets")
