...
def prepare():
    ...
    U.exec_command(f"hf download Qwen/Qwen2.5-0.5B-Instruct --local-dir /root/models/{MODEL_NAME}")
...
def _launch_background():
    # Here we use infra in slime, but real users will use their own infra
