...
- `--use-score-centering`: Enable [Score Centering](https://arxiv.org/abs/2609.20807) with the REINFORCE objective, optionally combined with TIS. See [configuration and sampling requirements](usage.md#score-centering).
