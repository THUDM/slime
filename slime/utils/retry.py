"""Bounded synchronous retry with exponential jittered backoff.

Caller supplies ``should_retry`` so the retry policy stays decoupled from
what counts as retryable. Backoff/jitter mirror ``slime/rollout/rm_hub``.
"""
