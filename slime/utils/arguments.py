    ...
    def add_slime_arguments(parser):
        ...
        def add_data_arguments(parser):
            ...
            parser.add_argument(
                ...
                default=False,
                help=(
                    "Freeze the vision encoder during training. Recommended for VLM SFT following "
                    "Qwen3-VL methodology: freeze vision encoder, train MLP adapter and LLM. "
                    "Reduces memory usage and prevents overfitting on small datasets."
                ),
            )
