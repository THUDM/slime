...
class Sample:
    ...
    multimodal_raw: dict[str, Any] = None  # raw multimodal data, e.g. images, videos, etc.
    multimodal_tensor: dict[str, Any] = None  # processed multimodal data, e.g. pixel_values, etc.
    # response
    response: str = ""
