...
class Sample:
    ...
    multimodal_data: dict[str, Any] = None  # raw multimodal data, e.g. images, videos, etc.
    multimodal_inputs: dict[str, Any] = None  # processed multimodal data, e.g. pixel_values, etc
    # response
    response: str = ""
