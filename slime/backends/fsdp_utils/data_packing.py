...
def pack_sequences(
    ...
    multimodal_tensor: list[dict] | None = None,
    ...
    Args:
        ...
        multimodal_tensor: List of dict of multimodal tensors per sequence
    ...
    for indices in partitions:
        ...
        if multimodal_tensor:
            ...
            packed_batch["multimodal_tensor"] = multimodal_data
        ...
        for key, value in packed_batch.items():
            if key not in instance:
                ...
                if key == "multimodal_num_items":
                    continue
                # Handle multimodal_tensor dict: split each tensor using multimodal_num_items
                elif key == "multimodal_tensor" and isinstance(value, dict):
                    instance[key] = {}
