...
def fused_moe_backward_weight_kernel(
    ...
    offs_token = tl.load(sorted_token_ids_ptr + offs_token_id, mask=offs_token_id < num_tokens_post_padded, other=num_valid_tokens)
    offs_token = offs_token.to(tl.int64)
...
def invoke_fused_moe_backward_kernel(
        ...
        grad_topk_weights: Optional[torch.Tensor],
