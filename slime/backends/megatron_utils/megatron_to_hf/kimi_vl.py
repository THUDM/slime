...
def convert_language_model_to_hf(args, name, param):
    ...
    if match:
        ...
        if rest == "eh_proj.weight":
            return [(f"language_model.model.layers.{layer_idx}.eh_proj.weight", param)]
        elif rest == "enorm.weight":
            return [(f"language_model.model.layers.{layer_idx}.enorm.weight", param)]
        elif rest == "hnorm.weight":
            return [(f"language_model.model.layers.{layer_idx}.hnorm.weight", param)]
        elif rest == "final_layernorm.weight":
            return [(f"language_model.model.layers.{layer_idx}.shared_head.norm.weight", param)]
        else:
