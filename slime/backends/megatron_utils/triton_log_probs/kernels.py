...
# Changes remove verl-specific device helpers and preserve slime's BF16 output boundary.
...
try:
    ...
    HAVE_TRITON = True
    SUPPORT_CUDA_TMA = torch.cuda.is_available() and torch.cuda.get_device_capability()[0] >= 9 and hasattr(
