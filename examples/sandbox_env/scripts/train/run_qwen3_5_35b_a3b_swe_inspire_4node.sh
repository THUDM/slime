...
SWE_WANDB_GROUP=qwen3.5-35b-a3b-swe-inspire-4node
SWE_WANDB_RUN_ID=qwen3.5-35b-a3b-swe-inspire-4node

# ── Output ────────────────────────────────────────────────────────────────────
WORK_ROOT_BASE="${SANDBOX_ENV_DIR}/output/qwen3_5_35b_4node"
