...
SWE_WANDB_GROUP=qwen3.5-35b-a3b-swe-inspire-6node
SWE_WANDB_RUN_ID=qwen3.5-35b-a3b-swe-inspire-6node

# ── Output ────────────────────────────────────────────────────────────────────
WORK_ROOT_BASE="${SANDBOX_ENV_DIR}/output/qwen3_5_35b_6node"
...
SWE_CONTEXT_PARALLEL_SIZE=32
SWE_EXPERT_MODEL_PARALLEL_SIZE=32
