...
WORK_ROOT_BASE=${WORK_ROOT_BASE:-${SCRIPT_DIR}/output_inspire_qwen3_5_35b_6node}
...
SWE_WANDB_GROUP=${SWE_WANDB_GROUP:-qwen3.5-35b-a3b-swe-inspire-6node}
SWE_WANDB_RUN_ID=${SWE_WANDB_RUN_ID:-qwen3.5-35b-a3b-swe-inspire-6node}
