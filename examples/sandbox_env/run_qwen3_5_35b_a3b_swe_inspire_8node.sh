...
ACTOR_NUM_NODES=${ACTOR_NUM_NODES:-6}
...
WORK_ROOT_BASE=${WORK_ROOT_BASE:-${SCRIPT_DIR}/output_inspire_qwen3_5_35b_8node}
...
SWE_NUM_ROLLOUT=${SWE_NUM_ROLLOUT:-8}
...
SWE_MAX_RESPONSE_LEN=${SWE_MAX_RESPONSE_LEN:-8192}
SWE_LR=${SWE_LR:-1e-6}
...
SWE_WANDB_GROUP=${SWE_WANDB_GROUP:-qwen3.5-35b-a3b-swe-inspire-8node}
SWE_WANDB_RUN_ID=${SWE_WANDB_RUN_ID:-qwen3.5-35b-a3b-swe-inspire-8node}
...
SWE_CONTEXT_PARALLEL_SIZE=${SWE_CONTEXT_PARALLEL_SIZE:-16}
