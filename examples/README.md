...
- **[partial_weight_sync](./partial_weight_sync)**: Non-colocated weight sync that broadcasts sparse-encoded partial updates (selective or delta) instead of full weights.
