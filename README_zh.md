...
- [External Rollout Engines](docs/zh/advanced/external-rollout-engines.md)，用于 serving 由训练任务外部管理的部署形态，并支持通过共享文件系统做 full checkpoint update from disk 或 delta update。
